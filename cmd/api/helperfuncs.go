...
func (app *application) writeJsonHelper(w http.ResponseWriter, status int, data interface{}, headers http.Header) error {
	// test case olduğundan performansı gözetmediğimden  json.marshall yerine marshallindent kullandım
	// biraz daha uzun sürer ve memory yer ama terminalde şık bir görüntü veriyor istek atınca terminalden
